...
/*!
 * @class StringCommanderComp
 * @brief Standalone component Class
 *
 */
public class StringCommanderComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(StringCommander.component_conf);
      mgr.registerFactory(prop, new StringCommander(), new StringCommander());

      // Create a component
      RTObject_impl comp = mgr.createComponent("StringCommander");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        StringCommanderComp init = new StringCommanderComp();
